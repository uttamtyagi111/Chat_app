...
urlpatterns = [
    ...
    path('widget/<str:widget_id>/update/', views.update_widget, name='update_widget'),  # PUT: Update a widget
    ...
    path('agent-chat/<str:room_id>/', ActiveRoomsAPIView.as_view(), name='agent_chat'),
