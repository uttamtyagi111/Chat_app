...
urlpatterns = [
    ...
    path('shortcuts/add/', views.add_shortcut, name='add-shortcut'),
    path('shortcuts/edit/<str:shortcut_id>/', views.edit_shortcut, name='edit-shortcut'),
    path('shortcuts/delete/<str:shortcut_id>/', views.delete_shortcut, name='delete-shortcut'),
    path('tags/', views.tag_list, name='tag-list'),
    path('tags/add/', views.add_tag, name='add-tag'),
    path('tags/edit/<str:tag_id>/', views.edit_tag, name='edit-tag'),
    path('tags/delete/<str:tag_id>/', views.delete_tag, name='delete-tag'),
